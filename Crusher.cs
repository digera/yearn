...
public class Sorter
{
    ...
    // each sorter has unique inputType and outputType, iterations from the enum in names
    public Sorter(Caravan caravan, StoneType inputType, StoneType outputType,
...
public class Crusher
{
    ...
    public int boxWidth;
    public int boxHeight;
    private const int extraYOffset = 300;
    private const int buttonSize = 20;
    private const int buttonMargin = 5;
...
public static class CrusherManager
{
